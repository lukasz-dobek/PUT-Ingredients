...
(5,'Zupa tajska z krewetkami','Zweryfikowany',0.0,'2019-05-11 23:00:00',null,3,'1h 30min','Do garnka wlać wodę lub bulion, dodać pastę tom yum i zagotować. Dodać mleko kokosowe, pomidory oraz odcedzone i pokrojone na połówki grzyby, gotować przez ok. 5 minut.
...
(7,'Pina Colada','Zweryfikowany',0.0,'2019-06-11 23:00:00',null,1,'30min','Wszystkie składniki oprócz lodu włożyć do blendera i dokładnie zmiksować.
...
(2,'Krem pomidorowy','Zweryfikowany',0.0,'2019-06-15 23:00:00',null,2,'1h 30min','W garnku na oliwie i maśle zeszklić pokrojoną w kosteczkę cebulę oraz pokrojony na plasterki czosnek. Wlać wino jeśli je używamy i gotować przez minutę.
...
(3,'Czekoladowy budyń jaglany','Zweryfikowany',0.0,'2019-06-19 23:00:00',null,1,'30min','Kaszę jaglaną przepłukać na sicie pod strumieniem ciepłej wody. Przełożyć do rondelka, wlać mleko, przykryć i zagotować. Zmniejszyć ogień i gotować pod przykryciem ok. 15 minut aż kasza wchłonie cały płyn i będzie miękka.
...
(3,'Kurczak Teriyaki','Zweryfikowany',0.0,'2019-06-19 21:00:00',null,2,'1h','Filety oczyścić z błonek i kostek. Ugotować brązowy ryż w osolonej wodzie zgodnie z instrukcją na opakowaniu (zwykle ok. 30 - 35 minut, ale warto sprawdzić). Odcedzić.
...
(6,'Pizzadilla z salami i papryką','Zweryfikowany',0.0,'2019-06-19 21:00:00',null,2,'30min','Paprykę pokroić w drobną kostkę, doprawić solą i podsmażyć chwilę na łyżeczce oliwy, odłożyć na talerz.
